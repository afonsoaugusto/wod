...
describe("CLASSIC_TEMPLATES", () => {
  ...
  it("Murph inclui pesos sugeridos M/F no colete", () => {
    ...
    const pullup = murph.config.blocks.wod.exercises.find((e) => e.name === "Pull-up");
  ...
  it("Fran inclui pesos de thruster", () => {
    ...
    const thruster = fran.config.blocks.wod.exercises[0];
  ...
  it("Chelsea usa EMOM de 30 minutos", () => {
    ...
    const wod = chelsea.config.blocks.wod;
...
describe("estimateDuration", () => {
  it("soma blocos sequenciais e descanso entre blocos", () => {
    ...
    // alongamento: 30+10+30 = 70, rest 60, wod: 720
...
describe("serializeConfig e exercícios com peso", () => {
  ...
  it("serializa weightUnit no config", () => {
    const state = {
      blocks: { alongamento: defaultBlock(), tecnica: defaultBlock(), wod: defaultBlock() },
      restBetweenBlocks: 60,
      weightUnit: "kg",
      layoutRatio: 55,
      soundEnabled: true,
